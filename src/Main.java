...
static void iniciarJogo(Scanner scanner, Baralho baralho, List<Jogador> jogadores, HistoricoJogo historico) {
    ...
    static int obterNumeroDeJogadores(Scanner scanner) {
        int numJogadores = 0;
